    ...
    <div class="card shadow-sm">
      ...
      <div class="card-body">
        <form action="{{ route('siswa.store') }}" method="POST">
          ...
          <div class="mb-3 row">
            <label for="id" class="col-sm-2 col-form-label">Id <span class="text-danger">*</span></label>
            <div class="col-sm-10">
              <input type="text" name="id" id="id" class="form-control" placeholder="Masukan Id" value="{{ old('id') }}">
              @error('id')
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="password" id="password" class="form-control" placeholder="Masukan Password" value="{{ old('password') }}">
              @error('password')
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="gender" id="gender" class="form-control" placeholder="Gender" value="{{ old('gender') }}">
              @error('gender')
